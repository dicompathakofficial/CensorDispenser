...
#as censoring everything from the list from the previous step as well.


# These are the emails you will be censoring. The open() function is opening 
#the text file that the emails are contained in and the .read() method is allowing us
#to save their contexts to the following variables:
...
# CODE on removing both negative words occuring twie or more than twice and 
#censoring everything on proprietory_terms variable
